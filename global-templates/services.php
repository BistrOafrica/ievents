...
<div class="section">
    ...
    <div class="row service-top">
        <div class="col-md-4"><h1 class="section-title"><?php echo get_option('service_Section_Title');?></h1></div>
        <div class="col-md-6"><p class="service-text"><?php echo get_option('section_Excerpt');?></p></div>
    </div>
